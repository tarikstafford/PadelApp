...
def upgrade() -> None:
    ...
    surface_type = postgresql.ENUM('Clay', 'Hard', 'Grass', 'Artificial Grass', 'Artificial Grass Pro', name='surfacetype')
    ...
    op.alter_column('courts', 'surface_type',
               type_=sa.Enum('CLAY', 'HARD', 'GRASS', 'ARTIFICIAL_GRASS', 'ARTIFICIAL_GRASS_PRO', name='surfacetype'),
