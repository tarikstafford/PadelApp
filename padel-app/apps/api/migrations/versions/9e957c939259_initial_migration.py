...
# Define the ENUM type for UserRole
user_role_enum = postgresql.ENUM('player', 'admin', 'super_admin', name='userrole')

def upgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    
    # Manually create the ENUM type if it doesn't exist
    op.execute("""
        DO $$
        BEGIN
