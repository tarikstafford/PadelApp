...
class TestAvailabilityService:
    ...
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    def test_get_court_availability_for_day_success(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
        ...
        result = get_court_availability_for_day(
            self.mock_db, court_id=self.court_id, target_date=self.target_date, duration=self.duration
        )
    ...
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    def test_get_court_availability_for_day_with_default_times(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
        ...
        mock_get_time_slots.return_value = [(datetime.time(9, 0), datetime.time(10, 30))]
    ...
    def test_get_court_availability_for_day_past_slots_unavailable(self, mock_datetime, mock_get_time_slots, mock_get_bookings, mock_get_court):
        ...
        # Verify
        assert len(result) == 3
        assert result[0].is_available == False  # Past slot
        assert result[1].is_available == True   # Current/Future slot
        assert result[2].is_available == True   # Future slot

    @patch('app.services.availability_service.crud.court_crud.get_court')
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    def test_get_court_availability_for_day_booked_slots_unavailable(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
        ...
        # Verify
        assert len(result) == 3
        assert result[1].is_available == False  # Booked slot

    @patch('app.services.availability_service.crud.court_crud.get_court')
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    def test_get_court_availability_for_day_slot_format(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
    ...
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    async def test_get_court_availability_for_range_success(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
        ...
        result = await get_court_availability_for_range(
            self.mock_db, court_id=self.court_id, start_date=start_date, end_date=end_date
        )
    ...
    @patch('app.services.availability_service.crud.court_crud.get_court')
    async def test_get_court_availability_for_range_court_not_found(self, mock_get_court):
    ...
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    async def test_get_court_availability_for_range_with_bookings(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
        ...
        assert day.slots[0].booked == True   # First slot is booked
        assert day.slots[1].booked == False  # Second slot is available

    @patch('app.services.availability_service.crud.court_crud.get_court')
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    async def test_get_court_availability_for_range_multiple_days(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
    ...
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    async def test_get_court_availability_for_range_time_slot_format(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
    ...
    @patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date')
    @patch('app.services.availability_service.get_time_slots')
    async def test_get_court_availability_for_range_with_default_times(self, mock_get_time_slots, mock_get_bookings, mock_get_court):
    ...
    def test_edge_case_same_start_end_date(self):
        ...
        with patch('app.services.availability_service.crud.court_crud.get_court') as mock_get_court:
            mock_get_court.return_value = self.mock_court
            
            with patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date') as mock_get_bookings:
                mock_get_bookings.return_value = []
                
                with patch('app.services.availability_service.get_time_slots') as mock_get_time_slots:
                    mock_get_time_slots.return_value = []
        ...
        with patch('app.services.availability_service.crud.court_crud.get_court') as mock_get_court:
            ...
            with patch('app.services.availability_service.crud.booking_crud.get_bookings_for_court_on_date') as mock_get_bookings:
                ...
                with patch('app.services.availability_service.get_time_slots') as mock_get_time_slots:
                    ...
                    result = get_court_availability_for_day(
                        self.mock_db, court_id=self.court_id, target_date=self.target_date, duration=0
                    )
