...
class TestClubAdminCRUD:
    ...
    def test_create_club_admin_success(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_create_club_admin_with_relationships(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_create_club_admin_duplicate_constraint(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_create_club_admin_invalid_user_id(self, db_session: Session, test_club: Club):
    ...
    def test_create_club_admin_invalid_club_id(self, db_session: Session, test_user: User):
    ...
    def test_get_club_admin_success(self, db_session: Session, test_user: User, test_club: Club):
        ...
        retrieved_admin = crud.club_admin_crud.get_club_admin(db_session, test_user.id, test_club.id)
    ...
    def test_get_club_admin_not_found(self, db_session: Session, test_user: User, test_club: Club):
        """Test club admin retrieval when record doesn't exist"""
        retrieved_admin = crud.club_admin_crud.get_club_admin(db_session, test_user.id, test_club.id)
        
        assert retrieved_admin is None

    def test_get_club_admin_wrong_user_id(self, db_session: Session, test_user: User, test_club: Club):
        ...
        retrieved_admin = crud.club_admin_crud.get_club_admin(db_session, 99999, test_club.id)
        
        assert retrieved_admin is None

    def test_get_club_admin_wrong_club_id(self, db_session: Session, test_user: User, test_club: Club):
        ...
        retrieved_admin = crud.club_admin_crud.get_club_admin(db_session, test_user.id, 99999)
        
        assert retrieved_admin is None

    def test_get_club_admins_by_club(self, db_session: Session, test_owner: User, test_club: Club):
    ...
    def test_get_club_admins_by_club_different_clubs(self, db_session: Session, test_owner: User, test_user: User):
    ...
    def test_get_club_admins_by_user(self, db_session: Session, test_owner: User, test_user: User):
    ...
    def test_get_club_admins_by_user_different_users(self, db_session: Session, test_owner: User, test_club: Club):
    ...
    def test_remove_club_admin_success(self, db_session: Session, test_user: User, test_club: Club):
        ...
        # Remove the admin
        removed_admin = crud.club_admin_crud.remove_club_admin(db_session, test_user.id, test_club.id)
    ...
    def test_remove_club_admin_not_found(self, db_session: Session, test_user: User, test_club: Club):
        """Test removing club admin that doesn't exist"""
        removed_admin = crud.club_admin_crud.remove_club_admin(db_session, test_user.id, test_club.id)
        
        assert removed_admin is None

    def test_remove_club_admin_wrong_user_id(self, db_session: Session, test_user: User, test_club: Club):
        ...
        removed_admin = crud.club_admin_crud.remove_club_admin(db_session, 99999, test_club.id)
    ...
    def test_remove_club_admin_wrong_club_id(self, db_session: Session, test_user: User, test_club: Club):
        ...
        removed_admin = crud.club_admin_crud.remove_club_admin(db_session, test_user.id, 99999)
    ...
    def test_club_admin_model_constraints(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_club_admin_model_relationships(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_club_admin_repr(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_club_admin_cascade_delete_user(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_club_admin_cascade_delete_club(self, db_session: Session, test_user: User, test_club: Club):
    ...
    def test_multiple_admins_same_club(self, db_session: Session, test_owner: User, test_club: Club):
        ...
        club_admins = crud.club_admin_crud.get_club_admins_by_club(db_session, test_club.id)
    ...
    def test_multiple_clubs_same_user(self, db_session: Session, test_owner: User, test_user: User):
        ...
        user_admins = crud.club_admin_crud.get_club_admins_by_user(db_session, test_user.id)
    ...
    def test_club_admin_edge_cases(self, db_session: Session, test_user: User, test_club: Club):
        ...
        admin = crud.club_admin_crud.get_club_admin(db_session, non_existent_user_id, test_club.id)
        assert admin is None
        
        admin = crud.club_admin_crud.get_club_admin(db_session, test_user.id, non_existent_club_id)
        assert admin is None
        
        # Test list operations with non-existent IDs
        admins = crud.club_admin_crud.get_club_admins_by_user(db_session, non_existent_user_id)
        assert len(admins) == 0
        
        admins = crud.club_admin_crud.get_club_admins_by_club(db_session, non_existent_club_id)
        assert len(admins) == 0
        
        # Test remove operations with non-existent IDs
        removed = crud.club_admin_crud.remove_club_admin(db_session, non_existent_user_id, test_club.id)
        assert removed is None
        
        removed = crud.club_admin_crud.remove_club_admin(db_session, test_user.id, non_existent_club_id)
        assert removed is None