...
class TestCreateBooking:
    def test_create_booking_success(self):
        ...
        mock_db.query.return_value.options.return_value.filter.return_value.first.return_value = mock_final_booking
    ...
    def test_create_booking_calculates_end_time(self):
        ...
        result = create_booking(mock_db, booking_data, user_id=1)
...
class TestCreateBookingWithGame:
    def test_create_booking_with_game_success(self):
        ...
        result = create_booking_with_game(mock_db, booking_data, user_id)
    ...
    def test_create_booking_with_game_creates_relationships(self):
        ...
        mock_db.query.return_value.options.return_value.filter.return_value.first.return_value = mock_booking_with_game
...
class TestBookingCRUDEdgeCases:
    ...
    def test_get_bookings_by_user_with_future_dates(self):
        ...
        result = get_bookings_by_user(
            mock_db, 
            user_id,
            start_date_filter=future_start,
            end_date_filter=future_end
        )
...
class TestBookingCRUDIntegration:
    def test_create_then_get_booking(self):
        ...
        mock_db.query.return_value.options.return_value.filter.return_value.first.return_value = created_booking
        
        # Create
        result_create = create_booking(mock_db, booking_data, user_id)
        
        # Reset mock for get operation
        mock_db.reset_mock()
        mock_db.query.return_value.filter.return_value.options.return_value.first.return_value = created_booking
    ...
    def test_create_booking_with_game_workflow(self):
        ...
        mock_db.query.return_value.options.return_value.filter.return_value.first.return_value = booking_with_game
        
        # Create booking with game
        created_booking = create_booking_with_game(mock_db, booking_data, user_id=1)
