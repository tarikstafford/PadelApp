...
class TestBookingsRouter:
    ...
    @patch('app.services.court_booking_service.court_booking_service.is_court_available')
    def test_create_booking_success(self, mock_court_available, mock_availability, client: TestClient, 
                                   player_auth_headers: dict, test_court: models.Court, db_session: Session):
    ...
    def test_create_booking_court_not_found(self, client: TestClient, player_auth_headers: dict):
    ...
    @patch('app.services.availability_service.get_court_availability_for_day')
    @patch('app.services.court_booking_service.court_booking_service.is_court_available')
    def test_create_booking_slot_not_available(self, mock_court_available, mock_availability, 
                                              client: TestClient, player_auth_headers: dict, 
    ...
    @patch('app.services.availability_service.get_court_availability_for_day')
    @patch('app.services.court_booking_service.court_booking_service.is_court_available')
    def test_create_booking_tournament_conflict(self, mock_court_available, mock_availability, 
                                               client: TestClient, player_auth_headers: dict, 
                                               test_court: models.Court):
    ...
    @patch('app.services.availability_service.get_court_availability_for_day')
    def test_create_booking_availability_service_error(self, mock_availability, client: TestClient, 
                                                      player_auth_headers: dict, test_court: models.Court):
    ...
    def test_create_booking_unauthorized(self, client: TestClient, test_court: models.Court):
    ...
    def test_create_booking_invalid_data(self, client: TestClient, player_auth_headers: dict):
    ...
    def test_create_booking_invalid_duration(self, client: TestClient, player_auth_headers: dict, test_court: models.Court):
    ...
    def test_create_booking_invalid_player_count(self, client: TestClient, player_auth_headers: dict, test_court: models.Court):
    ...
    def test_read_user_bookings_success(self, client: TestClient, player_auth_headers: dict, test_booking: models.Booking):
    ...
    def test_read_user_bookings_with_pagination(self, client: TestClient, player_auth_headers: dict, 
                                               db_session: Session, test_court: models.Court, 
    ...
    def test_read_user_bookings_with_date_filter(self, client: TestClient, player_auth_headers: dict, 
    ...
    def test_read_user_bookings_with_sorting(self, client: TestClient, player_auth_headers: dict, 
                                            test_booking: models.Booking):
    ...
    def test_read_user_bookings_invalid_pagination(self, client: TestClient, player_auth_headers: dict):
    ...
    def test_read_user_bookings_limit_exceeded(self, client: TestClient, player_auth_headers: dict):
    ...
    def test_read_booking_details_success(self, client: TestClient, player_auth_headers: dict, 
                                         test_booking: models.Booking):
    ...
    def test_read_booking_details_not_found(self, client: TestClient, player_auth_headers: dict):
        """Test reading details for non-existent booking."""
        response = client.get(
            f"{settings.API_V1_STR}/bookings/99999",
            headers=player_auth_headers
        )
        assert response.status_code == 404
        assert "Booking not found" in response.json()["detail"]

    def test_read_booking_details_unauthorized_access(self, client: TestClient, admin_auth_headers: dict, 
                                                     test_booking: models.Booking):
    ...
    def test_read_booking_details_unauthorized(self, client: TestClient, test_booking: models.Booking):
        """Test reading booking details without authentication."""
        response = client.get(f"{settings.API_V1_STR}/bookings/{test_booking.id}")
        assert response.status_code == 401

    def test_read_booking_details_invalid_id(self, client: TestClient, player_auth_headers: dict):
        """Test reading booking details with invalid ID format."""
        response = client.get(
            f"{settings.API_V1_STR}/bookings/invalid-id",
            headers=player_auth_headers
        )
        assert response.status_code == 422

    def test_booking_business_logic_edge_cases(self, client: TestClient, player_auth_headers: dict, 
                                              test_court: models.Court):
        ...
        with patch('app.services.availability_service.get_court_availability_for_day') as mock_availability:
            mock_availability.return_value = [
                Mock(start_time=past_time.isoformat(), is_available=True)
            ]
            with patch('app.services.court_booking_service.court_booking_service.is_court_available') as mock_court_available:
                mock_court_available.return_value = True
                response = client.post(
                    f"{settings.API_V1_STR}/bookings",
                    headers=player_auth_headers,
    ...
    def test_booking_concurrent_creation(self, client: TestClient, player_auth_headers: dict, 
                                        test_court: models.Court):
    ...
    def test_booking_data_validation_edge_cases(self, client: TestClient, player_auth_headers: dict, 
                                               test_court: models.Court):
    ...
    def test_booking_error_handling(self, client: TestClient, player_auth_headers: dict, 
                                   test_court: models.Court):
        ...
        with patch('app.services.availability_service.get_court_availability_for_day') as mock_availability:
            ...
            with patch('app.services.court_booking_service.court_booking_service.is_court_available') as mock_court_available:
                mock_court_available.return_value = True
                with patch('app.crud.booking_crud.create_booking') as mock_create_booking:
                    ...
                    assert response.status_code == 500
                    assert "An error occurred while creating the booking" in response.json()["detail"]

    def test_booking_service_integration(self, client: TestClient, player_auth_headers: dict, 
                                        test_court: models.Court):
    ...
    def test_booking_malformed_datetime(self, client: TestClient, player_auth_headers: dict, 
                                       test_court: models.Court):
    ...
    def test_booking_extreme_values(self, client: TestClient, player_auth_headers: dict, 
                                   test_court: models.Court):
    ...
    def test_booking_sql_injection_protection(self, client: TestClient, player_auth_headers: dict):
        ...
        assert response.status_code == 422  # Should fail validation, not cause server error