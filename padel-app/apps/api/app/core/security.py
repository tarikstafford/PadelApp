...
# The tokenUrl doesn't prevent this scheme from being used for other token types (like Bearer)
...
def decode_token_payload(token: str) -> Optional[TokenData]:
    ...
    try:
        ...
        # However, an explicit check or custom leeway might be desired in some scenarios.
