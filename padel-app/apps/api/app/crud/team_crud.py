...
class TeamCRUD:
    ...
    def create_team(self, db: Session, team_data: schemas.TeamCreate, creator_id: int) -> models.Team:
    ...
    def create_team_with_players(self, db: Session, name: str, players: List[models.User]) -> models.Team:
    ...
    def add_player_to_team(self, db: Session, team: models.Team, user: models.User) -> models.Team:
